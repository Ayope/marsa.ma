                    ...
                    <div class="d-flex containner">
                        ...
                        <div class="w-75 w-100 inputs" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <img src="{{asset('driving-liscences-img')}}/{{$deliveryman->drivingLisense->document}}" class="rounded">
                                </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <img src="{{asset('vehicle-img')}}/{{$deliveryman->vehicle->photo}}" class="rounded">
                                    </div>
                                </div>
